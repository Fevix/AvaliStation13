/datum/lore/codex/category/species
	...
	children = list(
		...
		/datum/lore/codex/category/avali,
...
// Bird lore
/datum/lore/codex/category/avali/add_content()
	name = "Avali"
	data = "The Avali are reptilian pack predators from the [quick_link("Skrell")] homeworld, Sirisai (Qerr'balak). While they evolved alongside the Skrell, their interactions with them \
	...
	terrain far too desolate and cold to be of interest to the Skrell. In more enlightened times, the Avali are a minority culture on many Skrell worlds, \
	...
	<br><br>\
	It is important to note that Avali names are unlike standard human names.  Their pack name precedes their given name."
	children = list(
		/datum/lore/codex/page/avali_packs,
		/datum/lore/codex/page/avali_physical
	)

/datum/lore/codex/page/avali_packs/add_content()
	name = "Avali Packs"
	keywords += list("Packs")
	data = "There are several packs you may come across;<small>\
	<br><br>\
	<b>Eshi</b><br>\
	A large, old, politically neutral pack heavily involved in efforts to get Avali into space. Probably the most \
	common pack to see outside of a [quick_link("Skrell")] colony, and probably the most numerous Avali pack outside of Sirisai and associated colonies.\
	<br><br>\
	<b>Nasemari</b><br>\
	...
	for working as spies and informants for the Skrell governments amongst other Avali.\
	<br><br>\
	<b>Ceea</b><br>\
...
/datum/lore/codex/page/avali_physical/add_content()
	name = "Physiology of Avali"
	data = "The Avali are, relative to other species, smaller than average, rarely reaching more than 2-3'/1m in height, and weigh less than \
	...
	side of a wall, but this comes at a cost.  Very loud noises are very painful for Avali, so be mindful of \
	your indoor voice when speaking with one. The Avali are omnivorous but generally prefer to eat meat wherever possible."
